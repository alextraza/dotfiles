...
autocmd FileType c,cpp,java,php,javascript,python,twig,xml,yml,phtml,vimrc,vim,css autocmd BufWritePre <buffer> :call setline(1,map(getline(1,"$"),'substitute(v:val,"\\s\\+$","","")'))
